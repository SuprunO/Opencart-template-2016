...
public class PayPage extends PageObject {
    ...
    private String COUNTRY = ".country_code:first-child option[value=US]";
    ...
    private String EXPIRATIONMONTH = ".cc_exp_month:first-child option[value=\"02\"]";
    private String EXPIRATIONYEAR = "[name=cc_exp_year] option[value=\"2020\"]";
    private String CVV = "[name=cc_cvv]";


    public void enterClientCredentialsPaypage(String FirstName, String LastName, String Address, String City, String PostalCode, String Phone, String Email, String IssuingBank, String CardNumber, String CVV2) {
    ...
    public void chooseExpirationMonth() {
        clickOn(this.EXPIRATIONMONTH);
    }

    public void chooseExpirationYear(){
        clickOn(this.EXPIRATIONYEAR);
    }
